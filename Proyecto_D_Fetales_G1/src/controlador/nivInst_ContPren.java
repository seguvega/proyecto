...
@Named ("porcia")
@RequestScoped
public class nivInst_ContPren implements Serializable{
	 ...
	 private LineChartModel lineModel1;
	    ...
	    private void createBarModel() {
	        ...
	        barModel.setTitle("Nivel de instrucción Vs Controles Prenatales");
	        ...
	        yAxis.setLabel("Controles Prenatales");
	        yAxis.setMin(0);
	        yAxis.setMax(4000);
	    }
	    ...
	    private void controles() {
	    	...
	    	try {
				c.iniciar_con();
				String sql1= "Select sum(con_pren) from tg_defuncionesfetales "
						+ "where niv_inst = 1 and anio_fall = "+getAnio();
				rs= c.Consulta(sql1);
				while(rs.next()) {
					n1=rs.getInt(1);
					setNivel1(n1);
				...
				//nivel 2
				String sql2="Select sum(con_pren) from tg_defuncionesfetales "
						+ "where niv_inst = 2 and anio_fall = "+getAnio();
				rs=c.Consulta(sql2);
				...
				String sql3="Select sum(con_pren) from tg_defuncionesfetales "
						+ "where niv_inst = 3 and anio_fall = "+getAnio();
				rs=c.Consulta(sql3);
				...
				String sql4="Select sum(con_pren) from tg_defuncionesfetales "
						+ "where niv_inst = 4 and anio_fall = "+getAnio();
				rs=c.Consulta(sql4);
				...
				//nivel 5 
				String sql5="Select sum(con_pren) from tg_defuncionesfetales "
						+ "where niv_inst = 5 and anio_fall = "+getAnio();
				rs=c.Consulta(sql5);
				...
				//nivel 6
				String sql6="Select sum(con_pren) from tg_defuncionesfetales "
						+ "where niv_inst = 6 and anio_fall = "+getAnio();
				rs=c.Consulta(sql6);
				...
				String sql7="Select sum(con_pren) from tg_defuncionesfetales "
						+ "where niv_inst = 7 and anio_fall = "+getAnio();
				rs=c.Consulta(sql7);
				...
				//nivel 8 
				String sql8="Select sum(con_pren) from tg_defuncionesfetales "
						+ "where niv_inst =8 and anio_fall = "+getAnio();
				rs=c.Consulta(sql8);
				...
				//nivel 9 
				String sql9="Select sum(con_pren) from tg_defuncionesfetales "
						+ "where niv_inst =9 and anio_fall = "+getAnio();
				rs=c.Consulta(sql9);
				...
				String sql10="Select sum(con_pren) from tg_defuncionesfetales "
						+ "where niv_inst = 10 and anio_fall = "+getAnio();
				rs=c.Consulta(sql10);
